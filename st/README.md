...
This is my version of the simple terminal from [suckless.org](https://st.suckless.org), based on the version from [Luke Smith](lukesmith.xyz).

## Todos
* [ ] Port to newest version
...
As of now, this is a blatant ripoff of luke's distro of the program, but in due time I hope to extend and customize it.
